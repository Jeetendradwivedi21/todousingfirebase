...
func init() {
	...
	opt := option.WithCredentialsFile("C:\\GO workspace\\todowithfirestore\\key\\handy-zephyr-403110-firebase-adminsdk-anp5t-6ac938c260.json") // Replace with the path to your Firebase credentials file
